  ...
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['drug:pharmacy:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['drug:pharmacy:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="药房的名字" prop="name">
          <el-input v-model="form.name" placeholder="请输入药房的名字" />
        </el-form-item>
        <el-form-item label="数量" prop="no">
...
<script>
import { listPharmacy, getPharmacy, delPharmacy, addPharmacy, updatePharmacy, exportPharmacy } from "@/api/drug/pharmacy";
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        name: [
          { required: true, message: "药房的名字不能为空", trigger: "blur" }
        ],
        no: [
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除药房库存编号为"' + ids + '"的数据项？').then(function() {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有药房库存数据项？').then(() => {
