    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['drug:storage:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['drug:storage:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listStorage, getStorage, delStorage, addStorage, updateStorage, exportStorage } from "@/api/drug/storage";
...
export default {
  ...
  methods: {
    ...
    handleExport() {
      ...
      this.$modal.confirm('是否确认导出所有药库库存数据项？').then(() => {
