    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['system:prescriptiontotal:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['system:prescriptiontotal:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['system:prescriptiontotal:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          @click="handleExport"
          v-hasPermi="['system:prescriptiontotal:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listPrescriptiontotal, getPrescriptiontotal, delPrescriptiontotal, addPrescriptiontotal, updatePrescriptiontotal, exportPrescriptiontotal } from "@/api/system/prescriptiontotal";
